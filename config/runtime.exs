...
# Quando DATABASE_URL estiver definida (ex.: Docker Compose), usa para o Repo e habilita TSDB.
...
#
#     PHX_SERVER=true bin/simulacoes_visuais start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :simulacoes_visuais, SimulacoesVisuaisWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :simulacoes_visuais, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :simulacoes_visuais, SimulacoesVisuais.Mailer,
